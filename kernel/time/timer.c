 ...
 *
 * Se conserva como funcion exportada en este arbol para no romper el ABI
 * GKI existente; el parche oficial la convierte en un inline de timer_delete().
 */
 ...
 * @timer:	The timer to be deactivated
 *
 * Equivalente a timer_delete_sync(); se conserva como funcion exportada en
 * este arbol para no romper el ABI GKI existente.
 *
 * Return:
 * * %0	- The timer was not pending
 * * %1	- The timer was pending and deactivated
